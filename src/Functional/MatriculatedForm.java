...
public class MatriculatedForm {
    ...
    public MatriculatedForm(Connection connection){
    
        this.connection = connection;
        this.validationUtils = new ValidationUtils();
        this.alertBox = new AlertBox();
        this. mainFormUI = new MatriculatedFormUI();
        this.mainFormUI.setTitle("       MATRICULATED");
    ...
    private void registerStudent(){
        ...
        String ssn="", firstName="", lastName="", middleName="", streetName="", 
                city="", zipCode="", state="", year="", degree="", diploma = "", immunForm = "";
        ...
        try{
            ...
            if(inputValidation(ssn, firstName, lastName, middleName, streetName, city, zipCode) &&
                    this.mainFormUI.getStateBox().getSelectionModel().getSelectedItem() != null &&
                    this.mainFormUI.getYearGroup().getSelectedToggle() != null && 
                    this.mainFormUI.getDegreeGroup().getSelectedToggle() != null &&
                    this.mainFormUI.getDiploma().isSelected()  && 
                    this.mainFormUI.getImmunForm().isSelected() ){
                
               if(isStudentExist(ssn) == false){
                
                state = String.valueOf(this.mainFormUI.getStateBox().getSelectionModel().getSelectedItem().trim());
                year = (String)this.mainFormUI.getYearGroup().getSelectedToggle().getUserData();
                degree = (String)this.mainFormUI.getDegreeGroup().getSelectedToggle().getUserData();
    ...
    private boolean inputValidation(String ssn, String firstName, String lastName,
        ...
        boolean isSSN, isFirstName, isLastName, isMiddleName, isStreetName, isCity, isZipCode;
