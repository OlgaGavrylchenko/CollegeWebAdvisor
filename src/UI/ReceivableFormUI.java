...
public class ReceivableFormUI implements FormUI_Iface{
    ...
    private void initializeForm(){
        ...
        this.formGridPane.add(firstS, 0, 1);
        GridPane.setConstraints(firstS, 0, 1, 22, 1, HPos.CENTER, VPos.CENTER);
        
        this.formGridPane.add(registerFormLabel[L_CLASS], 0, 2); //0,1
        this.formGridPane.add(registerFormTextFields[CLASS], 1, 2, 2, 1);//1,1,2,1
        this.registerFormTextFields[CLASS].setEditable(false);
        
        this.formGridPane.add(registerFormLabel[L_FIRSTNAME], 0, 3); //0,1
        this.formGridPane.add(registerFormTextFields[FIRSTNAME], 1, 3, 2, 1);//1,1,2,1
        ...
        this.formGridPane.add(this.bSearch, 8, 4);
        
        this.bClear = new Button("RESET");
        this.formGridPane.add(this.bClear, 9, 4);
       
        
        //create title
        Label title = new Label("FINANCIAL INFORMATION");
        title.setFont(TITLE_FONT_MEDIUM); 
        title.setPrefHeight(TITLE_HEIGHT);
        VBox titleHBox = new VBox(title, this.formGridPane);
    ...
    private void registerFormStyle(){
        ...
        this.formGridPane.setStyle(" -fx-background-color: #f0f0f5;");//#f0f0f5
